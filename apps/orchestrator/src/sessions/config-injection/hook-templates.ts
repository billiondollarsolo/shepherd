 ...
 * copy is `status/translators/templates/opencode-plugin/flock.js`, which Shepherd
...
/**
 * Absolute path to the authoritative US-18 OpenCode plugin source on disk. Shepherd
