...
export const FLOCK_REPOSITORY_URL = 'https://github.com/billiondollarsolo/flock';
    ...
    <div>
      ...
      <div className="space-y-4 rounded-lg border border-[var(--flock-border)] bg-flock-surface-1 p-5">
        <div className="flex items-center gap-2">
          <span className="font-wordmark text-xl font-semibold">Flock</span>
