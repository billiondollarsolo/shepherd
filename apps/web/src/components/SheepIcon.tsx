/**
 * Sheep — the Shepherd brand glyph (mdi-sheep), as a lucide-compatible icon.
 *
...
/** Shepherd brand blue — fixed (NOT theme-adaptive) so the mark matches the favicon. */
...
/**
 * FlockMark — the Shepherd brand mark: a rounded blue tile with a SOLID white sheep
...
export function FlockMark({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 28 28" role="img" aria-label="Shepherd" className={className} {...props}>
